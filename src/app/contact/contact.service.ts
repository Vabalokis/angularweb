...
export class AppService {
  ...
  messageboxFlash(msgstring){
    ...
    {
      this.switch = 1;
      let statbx = document.getElementById('statusbox');
  ...
  sendEmail(message: IMessage): Observable<IMessage> | any {
    let nameval =  (<HTMLInputElement>document.getElementById('nametextbox')).value ;
    let emailval =  (<HTMLInputElement>document.getElementById('emailtextbox')).value ;
    let messageval =  (<HTMLInputElement>document.getElementById('messagetextbox')).value ;
